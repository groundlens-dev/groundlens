...
target is 100–200 pairs per sub-domain. Do **not** target AUROC > 0.9: with authorship and length held constant, the measured ceiling for DGI and for logistic/MLP probes over the same embeddings is in the high 0.6s. Calibrate to size your second stage, not to hit a number. Held-out evaluation on a
